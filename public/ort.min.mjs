...
var $t = (e) => Wu(wn({}, "__esModule", { value: !0 }), e);
var vt,
  Ke,
  je,
  Gu,
    ...
    (vt = new Map()),
      ...
      (je = (e, t, n) => {
        if (
          ...
          let r = vt.get(e);
          if (r === void 0) vt.set(e, { backend: t, priority: n });
          else {
      ...
      (yr = async (e) => {
        ...
        return [
          o,
          new Proxy(e, {
            get: (u, d) => (d === "executionProviders" ? a : Reflect.get(u, d)),
          }),
        ];
      });
  });
...
var $r,
  ...
  xn = k(() => {
    ...
    Object.defineProperty(le, "logLevel", { enumerable: !0 });
  });
var ne,
  vr = k(() => {
    "use strict";
...
var Sn,
  ...
  Pr = k(() => {
    ...
    (Sn = (e, t) => {
      ...
      return u === "RGBA"
        ? new me("float32", l, [1, 4, n, r])
        : new me("float32", l, [1, 3, n, r]);
    }),
      (Ir = async (e, t) => {
            ...
            return new Promise((l, c) => {
              ...
              (m.crossOrigin = "Anonymous"),
                ...
                (m.onload = () => {
                  ...
                  (a.height = p.height), (a.width = p.width), l(Sn(h.data, a));
                });
            });
          throw new Error(
      ...
      (Br = () => {
        if (!zr) {
          ...
          let e = typeof BigInt64Array < "u" && BigInt64Array.from,
            ...
            r = typeof n < "u" && n.from;
          e && (Ze.set("int64", BigInt64Array), dt.set(BigInt64Array, "int64")),
            t &&
              (Ze.set("uint64", BigUint64Array),
              dt.set(BigUint64Array, "uint64")),
            r
              ? (Ze.set("float16", n), dt.set(n, "float16"))
              : Ze.set("float16", Uint16Array);
        }
      });
  });
var Or,
...
var St,
  ...
  In = k(() => {
    ...
    xn();
    (St = (e, t) => {
      (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) ||
      ...
      (ge = (e) => {
        (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || Rr("BEGIN", e);
      }),
      (fe = (e) => {
        (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || Rr("END", e);
      }),
      (Ne = (e) => {
        (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) ||
          console.time(`ORT::${e}`);
      ...
      async run(t, n, r) {
        ...
        for (let d in a)
          if (Object.hasOwnProperty.call(a, d)) {
            ...
            l instanceof Se
              ? (u[d] = l)
              : (u[d] = new Se(l.type, l.data, l.dims));
          }
        return Le("InferenceSession.run"), fe(), u;
      }
      async release() {
        return this.handler.dispose();
      }
      static async create(t, n, r, o) {
        ge(), Ne("InferenceSession.create");
        let i,
          s = {};
        if (typeof t == "string") {
        ...
        return Le("InferenceSession.create"), fe(), new e(d);
      }
      startProfiling() {
...
var Fr,
  ...
  Zr = k(() => {
    ...
    We();
    Ct();
    (Fr = "ort-wasm-proxy-worker"), (Kr = globalThis.self?.name === Fr);
    Kr &&
      (self.onmessage = (e) => {
        ...
        try {
          switch (t) {
            ...
            case "run": {
              ...
              Bt(r, o, i, s, new Array(s.length).fill(null), a).then(
                (u) => {
                  u.some((d) => d[3] !== "cpu")
                    ? postMessage({
                        type: t,
    ...
    qu = Kr ? null : (e) => new Worker(e ?? be, { type: "module", name: Fr });
  });
var Yr,
  Fu,
  Ku,
  ...
  Ct = k(() => {
    "use strict";
    It();
    (Yr = typeof location > "u" ? void 0 : location.origin),
      (Fu = import.meta.url > "file:" && import.meta.url < "file;"),
      (Ku = () => {
        if (!!1) {
          if (Fu) {
            let e = URL;
            return new URL(new e("ort.min.mjs", import.meta.url).href, Yr).href;
          }
      ...
      (En = (e, t) => {
        try {
          let n = t ?? be;
          return (n ? new URL(e, n) : new URL(e)).origin === Yr;
        } catch {
          return !1;
        }
      }),
      ...
      (Qu = async (e) => (await import(/*webpackIgnore:true*/ e)).default),
      (Qr = (Zr(), $t(jr)).default),
      (eo = async () => {
        if (!be)
          throw new Error(
  ...
  so = k(() => {
    ...
    (ed = (e) => {
      ...
      (Vt = (e, t, n, r) => {
        let o = _e(t, r),
          i = _e(n, r);
        te()._OrtAddSessionConfigEntry(e, o, i) !== 0 &&
      ...
      (rd = async (e, t, n) => {
        for (let r of t) {
            ...
            case "webgpu":
              if (((o = "JS"), typeof r != "string")) {
                ...
                if (l?.preferredLayout) {
                  ...
                  Vt(e, "preferredLayout", l.preferredLayout, n);
                }
              }
              break;
            case "wasm":
          ...
          let s = _e(o, n),
            ...
            d = 0;
          if (a > 0) {
            (u = te()._malloc(a * te().PTR_SIZE)),
              n.push(u),
              (d = te()._malloc(a * te().PTR_SIZE)),
              n.push(d);
            for (let l = 0; l < a; l++)
              te().setValue(u + l * te().PTR_SIZE, i[l][0], "*"),
                te().setValue(d + l * te().PTR_SIZE, i[l][1], "*");
          }
          (await te()._OrtAppendExecutionProvider(e, s, u, d, a)) !== 0 &&
      ...
      (io = async (e) => {
        ...
        nd(o);
        try {
          let i = ed(o.graphOptimizationLevel ?? "all"),
            s = td(o.executionMode ?? "sequential"),
            a = typeof o.logId == "string" ? _e(o.logId, r) : 0,
          ...
          if (
            ...
            o.executionProviders && (await rd(n, o.executionProviders, r)),
            ...
            Vt(n, "enableGraphCapture", o.enableGraphCapture.toString(), r);
          }
  ...
  Bn = k(() => {
    ...
    mt = async (e) => {
      if (typeof e == "string")
        if (!1)
          try {
            let { readFile: t } = $n("node:fs/promises");
            return new Uint8Array(await t(e));
          } catch (t) {
            if (t.code === "ERR_FS_FILE_TOO_LARGE") {
              let { createReadStream: n } = $n("node:fs"),
                r = n(e),
                o = [];
...
var Dn,
  ...
  q = k(() => {
    ...
    (Dn = class {
      ...
      (lo = -34028234663852886e22),
      (co = 34028234663852886e22);
  });
var Ht,
  On = k(() => {
    "use strict";
    ...
    (mo = new Map([
      ...
      (Un = (e, t) => {
        ...
        let o = e.byteLength / r,
          i = new (nt(t))(e.buffer, e.byteOffset, o);
        switch (t) {
          case "int64":
          case "uint64": {
      ...
      (qt = class {
        ...
        get byteLength() {
          return ho(this.dataType, this.tensorShape);
        }
        destroy() {
        ...
        async read(t) {
          if (this.fallbackDataType) {
            let n = await this.mlContext.readTensor(this.mlTensor),
              r = fo(new Uint8Array(n), this.dataType);
            if (t) {
              (t instanceof ArrayBuffer
                ? new Uint8Array(t)
      ...
      (Ft = class {
        ...
        async ensureTensor(t, n, r, o) {
          ...
          if (this.wrapper) {
            ...
            if (o) {
              if (this.wrapper.byteLength !== ho(n, r))
                throw new Error(
        ...
        async download(t) {
          if (this.activeUpload) {
            let n = this.wrapper?.isDataConverted
              ? fo(this.activeUpload, this.wrapper?.type)
              : this.activeUpload;
            if (t) {
              t instanceof ArrayBuffer
      ...
      (Mn = class {
        ...
        reserveTensorId() {
          let t = po();
          return this.tensorTrackersById.set(t, new Ft(this)), t;
        }
        releaseTensorId(t) {
        ...
        registerTensor(t, n, r, o) {
          ...
          return (
            this.tensorTrackersById.set(s, new Ft(this, a)),
  ...
  bo = k(() => {
    ...
    (Kt = new Map([
      ...
      (jt = class {
        ...
        uploadTensor(t, n) {
          if (!te().shouldTransferToMLTensor)
            throw new Error(
        ...
        registerMLConstant(t, n, r, o, i, s, a = !1) {
          ...
          switch (i.dataType) {
            ...
            case "int64":
              if (a) {
                let p = Un(new Uint8Array(l), "int64");
          ...
          return (
            j(
              "verbose",
              () =>
                `[WebNN] registerMLConstant {dataType: ${i.dataType}, shape: ${
                  i.shape
                }}} ${
                  a
    ...
    (_o = new Map([
      ...
      (Nn = class {
        ...
        memcpy(t, n) {
          ...
          let i = Vn(r.originalSize),
            s = this.backend.getCommandEncoder();
          this.backend.endComputePass(),
            s.copyBufferToBuffer(r.gpuData.buffer, 0, o.gpuData.buffer, 0, i);
        }
        ...
        async download(t, n) {
          ...
          await Ln(this.backend, r.gpuData.buffer, r.originalSize, n);
        }
...
var Ye,
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
          ...
          w = (E) => ((m.offsetToIndices = !0), s < 2 ? E : `o2i_${e}(${E})`),
          v = [];
        if (s >= 2)
          for (let E = s - 1; E >= 0; E--)
            v.push(`${O(y, E, s)} * (indices[${E}])`);
        let $ =
            s < 2
              ? ""
              : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
          ...
          T = (E) => ((m.indicesToOffset = !0), s < 2 ? E : `i2o_${e}(${E})`),
          I = (...E) =>
            s === 0 ? "0u" : `${p.indices}(${E.map(f).join(",")})`,
          A = (E, L) => (s < 2 ? `${E}` : `${O(E, L, s)}`),
          z = (E, L, oe) => (s < 2 ? `${E}=${oe};` : `${O(E, L, s)}=${oe};`),
          M = {},
          U = (E, L) => {
            m.broadcastedIndicesToOffset = !0;
            let oe = `${L.name}broadcastedIndicesTo${e}Offset`;
            if (oe in M) return `${oe}(${E})`;
            let $e = [];
            for (let xe = s - 1; xe >= 0; xe--) {
              let ue = L.indicesGet("outputIndices", xe + L.rank - s);
              $e.push(`${A(y, xe)} * (${ue} % ${A(b, xe)})`);
            }
            return (
          ...
          G = (E, L) =>
            (() => {
              if (p.storage === p.value) return `${e}[${E}]=${L};`;
              if (p.storage === "vec2<u32>" && p.value === "i32")
                return `${e}[${E}]=vec2<u32>(u32(${L}), select(0u, 0xFFFFFFFFu, ${L} < 0));`;
              if (p.storage === "vec2<u32>" && p.value === "u32")
                return `${e}[${E}]=vec2<u32>(u32(${L}), 0u);`;
              if (p.storage === "u32" && p.value === "vec4<bool>")
                return `${e}[${E}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${L}));`;
              throw new Error(
          ...
          B = (E) =>
            (() => {
              ...
              if (p.storage === "vec2<u32>" && p.value === "u32")
                return `u32(${e}[${E}].x)`;
              if (p.storage === "u32" && p.value === "vec4<bool>")
                return `vec4<bool>(bool(${e}[${E}] & 0xFFu), bool(${e}[${E}] & 0xFF00u), bool(${e}[${E}] & 0xFF0000u), bool(${e}[${E}] & 0xFF000000u))`;
              throw new Error(
                `not supported combination of storage type ${p.storage} and value type ${p.value} yet`
              );
            })(),
        ...
        return {
          impl: () => {
            let E = [],
              L = !1;
            return (
              m.offsetToIndices && (E.push(_), (L = !0)),
              m.indicesToOffset && (E.push($), (L = !0)),
              m.broadcastedIndicesToOffset &&
                (Object.values(M).forEach((oe) => E.push(oe)), (L = !0)),
              m.set && (E.push(Q), (L = !0)),
              m.setByIndices && (E.push(R), (L = !0)),
              m.get && (E.push(W), (L = !0)),
              m.getByIndices && (E.push(ee), (L = !0)),
              !i &&
                L &&
                E.unshift(
...
`)
      ...
      (S = (e, t, n, r = 1) => Qt(e, t, n, "input", r)),
      (C = (e, t, n, r = 1) => Qt(e, t, n, "output", r)),
      (So = (e, t, n) => Qt(e, t, n, "atomicOutput", 1)),
      (Xt = (e, t, n, r = 1) => Qt(e, t, n, "internal", r)),
      (Gn = class {
        constructor(t, n) {
...
var pd,
  ...
  Ue = k(() => {
    ...
    (pd = (e, t) => {
      ...
      (md = (e, t) => x.sortBasedOnPerm(e, Io(e.length, t))),
      (fd = (e, t, n, r) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: l, newPerm: c } = hd(e.dims, o),
  ...
  ${b.mainStart([h, h, 1])}
    ...
    if (input_row < uniforms.a_shape[0] && input_col < uniforms.a_shape[1]) {
      tile[local_id.y][local_id.x] = ${y.getByIndices(
        `${y.type.indices}(input_row, input_col)`
      )};
    }
    workgroupBarrier();
    ...
    if (output_row < uniforms.output_shape[0] && output_col < uniforms.output_shape[1]) {
      ${g.setByIndices(
        `${g.type.indices}(output_row, output_col)`,
...
var yd,
  ...
  Vo = k(() => {
    ...
    (yd = {
      ...
      (ze = (e, t, n, r) => {
        let o = e.inputs.length === 1 ? n : Fn(e.inputs, n),
          i = o.axes;
        i.length === 0 &&
          !o.noopWithEmptyAxes &&
        ...
        let s = x.normalizeAxes(i, e.inputs[0].dims.length),
          a = s,
          u = e.inputs[0],
          d = Td(a, e.inputs[0].dims.length);
        d.length > 0 &&
          ((u = e.compute(pe(e.inputs[0], d), {
            inputs: [0],
            outputs: [-1],
          })[0]),
          (a = $d(a.length, u.dims.length)));
        let [l, c] = vd(u.dims, a),
          p = l;
        o.keepDims && (p = xd(l, s)),
          e.compute(Id(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), {
            inputs: [u],
          });
      }),
      (Eo = (e, t) => {
...
`)
      ...
      (De = (e, t, n, r) => {
        let o = e.inputs,
          i = o.length === 1 ? n : Fn(o, n);
        e.compute(
          Jt(
            t,
            { hint: i.cacheKey, inputDependencies: ["rank"] },
            [o[0]],
            i.noopWithEmptyAxes && i.axes.length === 0 ? Cd : r,
            i.axes,
            o[0].dataType,
            i.keepDims,
            i.noopWithEmptyAxes
...
`)}`,
      ...
      (No = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bd(e, t) : Eo(e, t);
      }),
      (Lo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ed(e, t) : ko(e, t);
      }),
      (Wo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? kd(e, t) : Po(e, t);
      }),
      (Go = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pd(e, t) : zo(e, t);
      }),
      (Ho = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zd(e, t) : Bo(e, t);
      }),
      (qo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dd(e, t) : Do(e, t);
      }),
      (Fo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Od(e, t) : Oo(e, t);
      }),
      (Ko = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Md(e, t) : Mo(e, t);
      }),
      (jo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ud(e, t) : Uo(e, t);
      }),
      (Zo = (e, t) => {
        Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ad(e, t) : Ro(e, t);
      });
  });
var Qo,
  Xo,
...
var Rd,
      ...
      (Nd = (e, t, n, r, o, i, s, a, u) => {
        ...
        let I = (A) => {
          let z = S("q", t.dataType, t.dims, b),
            ...
            U = [z, M];
          if (v) {
            let R = S("past_key", r.dataType, r.dims, b);
            U.push(R);
          }
          o && U.push(S("attention_bias", o.dataType, o.dims));
          let G = a ? S("seq_lens", a.dataType, a.dims) : void 0;
          G && U.push(G);
          let B = u
          ...
          let ee = C("output", t.dataType, l),
            W = [ee];
          c && W.push(C("present_key", t.dataType, f, b));
          let D = ce(1, b),
            Z = [
              { name: "M", type: "u32" },
              { name: "K", type: "u32" },
  ...
  ${A.mainStart([g, g, 1])}
    ...
    let kv_num_heads = ${
      m === 1 ? "uniforms.num_heads" : "uniforms.num_heads / uniforms.n_reps"
    };
    let batchIdx = workgroup_id.z / uniforms.num_heads;
      ...
      (Ld = (e, t, n, r, o, i, s = void 0, a = void 0) => {
        ...
        let v = ($) => {
          ...
          let M = a
            ...
            : void 0;
          a && A.push(M);
          let G = [C("output", t.dataType, m)];
          c && G.push(C("present_value", t.dataType, f));
          let B = [
            { name: "M", type: "u32" },
            { name: "K", type: "u32" },
            { name: "N", type: "u32" },
  ...
  ${$.mainStart([h, h, 1])}
   ...
   let kv_num_heads = ${
     d === 1 ? "uniforms.num_heads" : "uniforms.num_heads / uniforms.n_reps"
   };
   let m = global_id.y;
   let n = global_id.x;
   let sequence_length = uniforms.M;
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      (rt = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
        ...
        p > 1 && s && x.size(s.dims) > 0 && b.push(s),
          ...
          l && b.push(l),
          c && b.push(c);
        let y = e.compute(Nd(p, t, n, s, h, d, f, l, c), {
          inputs: b,
          outputs: p > 1 ? [-1, 1] : [-1],
        })[0];
        e.compute(
          Vd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c),
    ...
    ${b.setByOffset("global_idx", "value")}
      ...
      (ti = (e, t) => {
        let { inputs: n, outputCount: r } = e,
          o = qd({ ...t, outputCount: r });
        if ((ne.webgpu.validateInputContent && Gd(n, o), t.trainingMode))
          throw new Error(
...
var Fd,
  ...
  ${l.mainStart()}
    ...
    let value = ${i.getByOffset("global_idx")}
      + ${s.getByOffset("global_idx % channels")} + ${a.getByOffset(
            "global_idx"
          )};
      ...
      (J = (e, t, n, r, o, i = e.dataType, s, a) => {
        ...
        return (
          s && u.push(...s),
          {
            ...
            getShaderSource: (d) =>
              jd(d, x.size(e.dims), e.dataType, i, n, r, a),
            getRunData: (d) => ({
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      (_i = (e) => {
        ...
        e.compute(J(e.inputs[0], "Erf", (n) => `erf_vf32(${n})`, tn(t)));
      }),
      (wi = (e) => {
...
`),
      ...
      (Ui = (e) => {
        let t = ce(e.inputs[0].dataType);
        e.compute(
          J(e.inputs[0], "FastGelu", Qn, Zn(t), void 0, e.inputs[0].dataType)
        );
      }),
      (Ri = (e, t) => {
        let n = ce(e.inputs[0].dataType);
    ...
    (el = (e, t, n, r, o, i, s, a, u, d, l, c) => {
      ...
      if (o)
            ...
            ${m.setByOffset(
              ...
              f(
                s || w
                  ...
                  : `${h.type.value}(${h.getByOffset(
                      "offsetA / 4u"
                    )}[offsetA % 4u])`,
                s || v
                  ? b.getByOffset("offsetB / 4u")
                  : `${b.type.value}(${b.getByOffset(
                      "offsetB / 4u"
                    )}[offsetB % 4u])`
              )
            )}
        ...
        let g = (_, w, v = "") => {
          ...
          return `
            let outputIndices${w} = ${m.offsetToIndices(
            `global_idx * 4u + ${w}u`
          )};
            let offsetA${w} = ${h.broadcastedIndicesToOffset(
            `outputIndices${w}`,
            m
          )};
            let offsetB${w} = ${b.broadcastedIndicesToOffset(
            `outputIndices${w}`,
            m
          )};
      ...
      (tl = (e, t, n, r, o, i, s = n.dataType) => {
        ...
        return (
          m.push(p),
          {
            ...
            getShaderSource: (h) =>
              el(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
            getRunData: () => ({
    ...
    (Ie = (e, t, n = "f32") => {
      ...
      (rn = (e) => {
        ...
        if (t === "HardSigmoid") {
          ...
          let [n, r] = e?.activation_params || [lo, co];
...
`;
      ...
      (sn = (e, t, n, r, o = !1, i) => {
        ...
        Ce(t, _),
          ...
          _.push(...P(g));
        let w = (v) => {
          let $ = Xt("batch_dims", e[0].dataType, b.length),
          ...
          if (h) {
            let W = o ? c : 1;
            U.push(S("bias", e[2].dataType, e[2].dims.length, W)),
              (G = `${
                o
                  ? `value += bias[col / ${W}];`
                  : `value += ${A.type.value}(bias[row + i]);`
              }`);
          }
          let B = [
          ...
          Ae(t, B);
          let ee = () => {
            let W = `var a_data: ${T.type.value};`;
            for (let D = 0; D < p; D++)
              W += `
              let b_data${D} = b[(b_offset + (k + ${D}) * uniforms.N + col) / ${c}];`;
            for (let D = 0; D < f; D++) {
              W += `a_data = a[(a_offset + (row + ${D}) * uniforms.K + k) / ${p}];`;
              for (let Z = 0; Z < p; Z++)
                W += `
            values[${D}] = fma(${I.type.value}(a_data${
                  p === 1 ? "" : `[${Z}]`
                }), b_data${Z}, values[${D}]);
`;
            }
...
var al,
  ...
  un = k(() => {
    ...
    (al = (e, t) =>
      ...
      (Xn = (e, t, n = "f32", r, o = !1, i = 32, s = !1, a = 32) => {
        let u = t[1] * e[1],
          d = t[0] * e[0],
          l = o ? u : i,
          c = o ? i : u,
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  let num_tiles = ${
    s ? `${Math.ceil(a / i)}` : "(uniforms.dim_inner - 1) / tileInner + 1"
  };
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      (Yn = (e, t, n = "f32", r, o = !1, i = 32, s = !1, a = 32, u = !1) => {
        let d = e[1] * t[1],
          l = e[0] * t[0],
          c = o ? d : i,
          p = o ? i : d;
    ...
    for (var t = 0; t < num_tiles; t = t + 1) {
      ...
      for (var inputRow = localRow; inputRow < ${p}; inputRow = inputRow + ${
        ...
        for (var inputCol = localCol; inputCol < ${c}; inputCol = inputCol + ${
                t[0]
              }) {
          ${as(o, r)}
        }
      ...
      // Load one tile of B into local memory.
      for (var inputRow = localRow; inputRow < ${i}; inputRow = inputRow + ${
                t[1]
              }) {
            for (var inputCol = localCol; inputCol < ${l}; inputCol = inputCol + ${
                t[0]
              }) {
...
`;
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${de(e, d)}) {
      ...
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        ...
        ${
          t
            ? `value = value + ${o ? "bias[colIn]" : `${de(e, d)}(bias[row])`};`
            : ""
        }
        ${n}
    ...
    `;
      ...
      (gt = (e, t, n, r, o = !1, i) => {
        ...
        let U = (G) => {
          let B = l.length,
            ee = Xt("batchDims", e[0].dataType, B, 1),
            W = re(e[0].dataType),
            D = S("a", e[0].dataType, v, _),
            Z = S("b", e[1].dataType, T, _),
            R = C("result", e[0].dataType, I.length, _),
            Q = [D, Z];
          if (M) {
            let L = o ? _ : 1;
          ...
          Ae(t, we);
          let se = re(R.type.tensor),
            H = Ie(t, R.type.value, se),
            E = ll(_, M, H, [ee, D, Z, R], o);
          return `
  ${G.registerUniforms(we)
    .registerInternalVariables(ee)
    .declareVariables(...Q, R)}
  ${E}
...
var cl,
  ...
  ds = k(() => {
    ...
    ss();
    un();
    (cl = (e, t, n, r, o = !1, i, s = 4, a = 4, u = 4, d = "f32") => {
      let l = (z) => {
          switch (z) {
            case 1:
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      (us = (e, t, n, r, o, i, s, a, u) => {
        ...
        Ce(t, G), G.push(...P(e[0].dims, e[1].dims));
        let B = ["rank", "rank"];
        s && (G.push(...P(e[2].dims)), B.push("rank")), G.push(...P(n));
        let ee = (W) => {
          let D = [
            { name: "dim_a_outer", type: "i32" },
            { name: "dim_b_outer", type: "i32" },
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${
        ...
        setOutputAtIndex(flatIndex ${h ? "/ 4" : ""}, value);
            ...
            we = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v),
            se = S("w", e[1].dataType, e[1].dims.length, Z),
            H = [we, se],
            E = C("result", e[0].dataType, n.length, Z);
          if (s) {
        ...
        ${
          h
            ? Xn(_, g, R, void 0, !d, I)
            : Yn(_, g, R, void 0, !d, I, !1, void 0, a)
        }`;
        };
        return {
          name: "Conv2DMatMul",
...
var pl,
  ...
  fs = k(() => {
    ...
    (pl = (e) => {
      ...
      (ls = (e) => (typeof e == "number" ? [e, e, e] : e)),
      (dn = (e, t) => (t <= 1 ? e : e + (e - 1) * (t - 1))),
      (ml = (e, t, n, r = 1) => {
        let o = dn(t, r);
      ...
      (fl = (e, t, n, r, o, i, s, a, u, d) => {
        ...
        if ((e === "VALID" && (e = 0), typeof e == "number")) {
          ...
          let m = cs([t, n, r, 1], [a, u, d], 1, [o, i, s], e);
          (c = m[0]), (p = m[1]), (f = m[2]);
          ...
          let m = cs([t, n, r, 1], [a, u, d], 1, [o, i, s], e[0]);
          (c = m[0]), (p = m[1]), (f = m[2]);
      ...
      (ps = (e, t, n, r, o, i = !1, s = "channelsLast") => {
        let a, u, d, l, c;
        ...
        let [p, , f, m, h] = t,
          ...
          I = dn(h, v),
          {
            ...
            outHeight: M,
            outWidth: U,
          } = fl(o, u, d, l, b, y, g, $, T, I),
          G = i ? p * c : p,
          B = [0, 0, 0, 0, 0];
        return (
          s === "channelsFirst"
            ? (B = [a, G, z, M, U])
            : s === "channelsLast" && (B = [a, z, M, U, G]),
          {
            batchSize: a,
            dataFormat: s,
            inDepth: u,
      ...
      (ms = (e, t, n, r, o, i) => {
        let s = i === "channelsLast",
          ...
          d = [64, 1, 1],
          l = { x: n.map((g, _) => _) },
          c = [Math.ceil(pl(l.x.map((g) => n[g])) / d[0]), 1, 1];
        ...
        let y = (g) => {
          ...
          let w = u ? 4 : 1,
            ...
            z = "";
          if (b) {
            let G = S("bias", e[2].dataType, e[2].dims.length, w);
            I.push(G),
              (z += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${
          u ? `vec4<${v}>` : v
        } {
          return bias[${s ? O("coords", 4, 5) : O("coords", 1, 5)}${
                u ? "/ 4" : ""
              }];
        }`);
          }
          ...
          ${g.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
              ...
              let d2 = ${
                s ? O("coords", $.rank - 1, $.rank) : O("coords", 1, $.rank)
              };
              let xFRCCorner = vec3<u32>(${
                s ? O("coords", 1, $.rank) : O("coords", 2, $.rank)
              },
              ${s ? O("coords", 2, $.rank) : O("coords", 3, $.rank)},
              ${
                s ? O("coords", 3, $.rank) : O("coords", 4, $.rank)
              ...
              let xShapeY = ${
                s
                  ? O("uniforms.x_shape", 1, $.rank)
                  : O("uniforms.x_shape", 2, $.rank)
              };
              let xShapeZ = ${
                s
                  ? O("uniforms.x_shape", 2, $.rank)
                  : O("uniforms.x_shape", 3, $.rank)
              };
              let xShapeW = ${
                s
                  ? O("uniforms.x_shape", 3, $.rank)
                  : O("uniforms.x_shape", 4, $.rank)
              };
              let xShapeU = ${
                s
                  ? O("uniforms.x_shape", 4, $.rank)
...
var hs,
  ...
  ${b.mainStart()}
    ...
    let xRCCorner: vec2<u32> = vec2<u32>(outputIndices[${
      u ? 1 : 2
    }], outputIndices[${u ? 2 : 3}]) * uniforms.strides - uniforms.pads;
...
var hl,
  ...
  _s = k(() => {
    ...
    (hl = (e, t, n, r, o, i) => {
      ...
      (bs = (e, t, n, r) => {
        let o = n.format === "NHWC",
          i = hl(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
        if (n.group !== 1) {
          let $ = [t[0]];
          if (o) {
            let I =
            ...
            n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = I),
              $.push(I);
          } else $.push(t[1]);
          t.length === 3 && $.push(t[2]),
            ...
            n.dilations[0] === 1 &&
            n.dilations[1] === 1
              ? e.compute(gs($, n, i, r), { inputs: $ })
              : e.compute(hs($, n, i, r), { inputs: $ });
          return;
        }
        let s = t.length === 3,
          a = t[0].dims[o ? 1 : 2],
        ...
        if (
          ...
          s && z.push(t[2]);
          let M = A[2],
            U = z[0].dims[z[0].dims.length - 1];
          M < 8 && U < 8
            ? e.compute(sn(z, n, i, A, o, r), { inputs: z })
        ...
        let _ = o ? p * f : m,
          w = o ? m : p * f,
          v = l * c * d;
        e.compute(us(g, n, i, _, w, v, s, b, r), { inputs: g });
      }),
      (yl = (e, t) => {
        let n = t.format === "NHWC",
          r = [
        ...
        bs(e, r, u, (d) => (n ? [d[0], d[2], d[3]] : [d[0], d[1], d[3]]));
      }),
      (bl = (e, t, n) => {
        let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst",
          o = er(n, t),
          i = n.autoPad === "NOTSET" ? n.pads : n.autoPad,
          s = ps(t[0].dims, t[1].dims, n.strides, n.dilations, i, !1, r);
        e.compute(
          ms(
            t,
            o,
    ...
    ws = (e, t, n) => {
      ...
      let A = (z) => {
        ...
        w_offset += 1u;`)
                : l === 2
                ? (H += `
          dotProd = dotProd + dot(vec4<${U}>(${D.getByOffset(
                    "x_offset"
                  )}, ${D.getByOffset(
                    "x_offset + 1u"
                  )}), vec4<${U}>(${W.getByOffset("w_offset")}, ${W.getByOffset(
                    "w_offset + 1u"
                  )}));
          x_offset += 2u;
          w_offset += 2u;`)
          ...
          dotProd = dotProd + dot(vec4<${U}>(${D.getByOffset(
                    "x_offset"
                  )}, ${D.getByOffset("x_offset + 1u")}, ${D.getByOffset(
                    "x_offset + 2u"
                  )}, ${D.getByOffset(
                    "x_offset + 3u"
                  )}), vec4<${U}>(${W.getByOffset("w_offset")}, ${W.getByOffset(
                    "w_offset + 1u"
                  )}, ${W.getByOffset("w_offset + 2u")}, ${W.getByOffset(
                    "w_offset + 3u"
                  )}));
          x_offset += 4u;
          w_offset += 4u;`);
              ...
              ((H += `
                  let xValue = ${
                    i
                      ? D.getByOffset(
                          `${D.indicesToOffset(
                            `${D.type.indices}(batch, idyR, idyC, inputChannel)`
                          )} / ${l}`
                        )
        ...
        `),
              ...
              H += `
          let w_offset = ${W.indicesToOffset(
            `${W.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel, wOutChannel)`
          )};
          ...
          dotProd = dotProd + xValue * wValue;`;
              ...
              for (let E = 0; E < l; E++)
                H += `
            let wValue${E} = ${W.getByOffset(
                  `${W.indicesToOffset(
                    `${W.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel + ${E}, wOutChannel)`
                  )} / ${h}`
                )};
          ...
          we = () => {
            ...
            if (l === 1) {
              ...
              for (let E = 0; E < f; E++)
                H += `
            + ${D.getByOffset(`x_offset + ${E}`)} * ${W.getByOffset(
                  `w_offset + ${E}`
                )}`;
              H += ";";
            } else if (l === 2) {
            ...
            for (; wR < uniforms.effective_filter_dims.x; wR = wR + 1) {
              ...
              for (; wC < uniforms.effective_filter_dims.y; wC = wC + 1) {
                ...
                ${
                  c
                    ? `
                var x_offset = ${D.indicesToOffset(
                  `${D.type.indices}(batch, idyR, idyC, inputChannel)`
                )} / ${l};
                var w_offset = ${W.indicesToOffset(
                  `${W.type.indices}(wRPerm, wCPerm, inputChannel, wOutChannel)`
                )} / ${h};
                  `
                    : ""
                }
...
var _l,
  ...
  Is = k(() => {
    ...
    qe();
    Ue();
    (_l = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
      (wl = (e, t, n, r, o) => {
      ...
      ($l = (e, t, n, r, o, i, s, a, u, d) => {
        ...
        for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
          let b = e[h],
            y = c ? b * s[m] : d[m],
            g = _l(b, s[m], i[m], t[h], n[m], y);
          wl(g, r, i, m, m + l),
            c &&
              d.push(
                s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]
              );
        }
      ...
      (Ss = (e, t, n, r) => {
        ...
        let i = [t[0], o];
        t.length === 3 && i.push(t[2]), e.compute(ws(i, n, r), { inputs: i });
      }),
      (xl = (e, t) => {
        let n = t.format === "NHWC",
          r = [
        ...
        Ss(e, r, d, (l) => (n ? [l[0], l[2], l[3]] : [l[0], l[1], l[3]]));
      }),
      (Ts = (e, t) => {
      ...
      let o = x.size(t),
        ...
        l = (c) => {
          let p = ` i32(${s.indicesGet("inputIndices", "uniforms.axis")}) `,
            f = O("uniforms.input_shape", "uniforms.axis", i),
      ...
      (Cl = (e, t) => {
        ...
        u
          ...
          : (([n, r, o, i] = [e.dims[0], e.dims[2], e.dims[3], e.dims[1]]),
            (s = l ? [n, d, d, i / d ** 2, r, o] : [n, i / d ** 2, d, d, r, o]),
        ...
        constructor(t, n) {
          ...
          if (
            (r.split(",").forEach((a, u) => {
              ...
              if (!a.match(RegExp(Bs))) throw new Error("Invalid LHS term");
            ...
            o += [...this.symbolToInfo.entries()]
              ...
              .map(([a]) => a)
              .join("");
          else if (!o.match(RegExp(ln))) throw new Error("Invalid RHS");
          o.match(RegExp(rr, "g"))?.forEach((a) => {
            if (a === "...")
          ...
          d = (l) => {
            ...
            let w = _
              ? [
                  ...c,
                  `let sum = ${i
                    .map((v, $) => v.getByIndices(`input${$}Indices`))
                    .join(" * ")};`,
                ]
              : [...c, f, ...b, ...h, p, ...g, m, ...y];
            return `
...
`)};
      ...
      (Os = (e, t) => {
        let n = new ir(e.inputs, t.equation),
          r = n.outputDims,
...
var Pl,
  ...
  Ns = k(() => {
    ...
    (Pl = (e) => {
      ...
      (zl = (e, t) => (e.length > t.length ? Rs(e, t) : Rs(t, e))),
      (Bl = (e) => {
        let t = e[0].dims,
          n = Array.from(e[1].getBigInt64Array(), Number),
          r = zl(t, n),
          ...
          let offset${y} = ${p.broadcastedIndicesToOffset(
                `outputIndices${y}`,
                f
              )};
    ...
    ${s.mainStart(Ye)}
      ...
      return {
        ...
        getRunData: (s) => ({
          ...
          dispatchGroup: { x: Math.ceil(n / Ye / 4) },
        }),
      };
    }),
      (Ls = (e) => {
      ...
      (Ml = (e, t) => {
          ...
          c = (p) => {
            let f = S("data", e[0].dataType, e[0].dims.length, u),
              ...
              b = (g) => {
                ...
                for (let v = 0; v < _; v++)
                  w += `${
                    _ > 1 ? `indicesIndices${g}[${v}]` : `indicesIndices${g}`
                  } = ${
                    s.length > 1
                      ? `outputIndices${g}[uniforms.axis + ${v}]`
                      : `outputIndices${g}`
                  };`;
                w += `
        ...
        `;
                for (let v = 0, $ = 0; v < o; v++)
                  v === i
                    ? ((w += `${
                        o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`
                      } = u32(idx${g});`),
                      ($ += _))
                    : ((w += `${
                        o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      (Fs = (e, t) => {
        ...
        let m = Ul(e, n[1], p, t.batchDims, r, a, c, l, s),
          h = t.batchDims + s;
        if (h > r.length)
          throw new Error(
      ...
      (Ks = (e) => ({ batchDims: e.batch_dims, cacheKey: "" }));
  });
var Rl,
  Vl,
  Zs,
      ...
      (Vl = (e, t) => {
        ...
        ${
          ...
          for (var i: u32 = 0; i < ${r.length}; i++) {
            let index = ${_.indicesGet(
              "output_indices",
              "uniforms.gather_axis + i"
            )};
            ${b.indicesSet("indices_indices", "i", "index")};
          }`
            : `indices_indices = ${_.indicesGet(
                "output_indices",
        ...
        ${
          g
            ? `
              ...
              let zero_point_offset = ${g.indicesToOffset(
                "zero_point_indices"
              )};
              let zero_point_index = zero_point_offset % 8;
              let packed_4bit_zero_points = ${g.getByOffset(
                "zero_point_offset / 8"
              )};
...
var Wl,
  ...
  ${y.mainStart([u, u, 1])}
    ...
    ${
      w != null
        ? `let cOffset = ${w.broadcastedIndicesToOffset(
            "vec2(m, n)",
            $
          )}; value += ${$.type.value}(uniforms.beta) * ${w.getByOffset(
            "cOffset"
          )};`
        : ""
    }
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      (yt = (e, t, n, r, o, i, s, a) => {
        ...
        if (s && x.size(s.dims) > 0) {
          ...
          return (
            (u = tc(e, i, s, t, r, n * o, a)),
            (u = u.reshape([t, r, n, o])),
            n === 1 || r === 1
              ? u
              : e.compute(pe(u, aa.perm), { inputs: [u], outputs: [-1] })[0]
          );
        } else
          return (
      ...
      (da = (e, t) => {
        ...
        if (c) return rt(e, p, o, i, a, void 0, d, l, u, n);
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      (la = (e, t) => {
        ...
        e.compute(ar(e.inputs, n), { inputs: [0] });
      }),
      (ca = (e) => {
        let t = e.axis,
          n = e.splitSizes,
      ...
      (cn = (e, t) => {
        ...
        ${b.mainStart(Ye)}
          ...
          if (bsnh[3] < half_rotary_emb_dim) {
            ...
            let re = ${y.getByOffset("i")} * ${_.get(
                "position_id",
                "bsnh[3]"
              )} -
                ${y.getByOffset("j")} * ${w.get("position_id", "bsnh[3]")};
            ${v.setByOffset("i", "re")}
            let im = ${y.getByOffset("i")} * ${w.get(
                "position_id",
                "bsnh[3]"
              )} +
        ...
        return {
          ...
          getRunData: () => ({
            outputs: [{ dims: e[0].dims, dataType: e[0].dataType }],
            dispatchGroup: { x: Math.ceil(x.size(p) / Ye) },
            programUniforms: m,
          }),
        };
      }),
      (pa = (e, t) => {
        sc(e.inputs, t), e.compute(cn(e.inputs, t));
      });
  });
var ac,
  uc,
      ...
      (ma = (e, t, n) => {
        ...
        return (
          t.dims.length === 3 &&
            ...
            (r = e.compute(pe(r, uc.perm), { inputs: [r], outputs: [-1] })[0])),
          r
        );
      }),
      (dc = (e, t, n, r) => {
  ...
  `;
      ...
      (fa = (e, t) => {
        ...
        let r = e.inputs[0],
          ...
          [p, f, m] =
            !o && !i
              ? e.compute(ar([r], c), { inputs: [r], outputs: [-1, -1, -1] })
              : [r, o, i],
          h,
          b;
        if (t.doRotary) {
          let w = e.compute(dc(n.batchSize, n.sequenceLength, u, d), {
              inputs: [u, d],
              outputs: [-1],
            })[0],
            v = e.inputs[7],
            ...
            I = [p, w, v, $],
            A = [-1];
          (h = e.compute(cn(I, T), { inputs: I, outputs: A })[0]),
            I.splice(0, 1, f);
          let z = N({
            interleaved: t.rotaryInterleaved !== 0,
          ...
          b = e.compute(cn(I, z), { inputs: I, outputs: A })[0];
        }
        let y = yt(
            e,
            n.batchSize,
          ...
          g = ma(e, t.doRotary ? b : f, n),
          _ = ma(e, m, n);
        rt(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
      });
  });
var ga,
  lc,
    ...
    if (local_idx == 0) {
      ...
      (lc = (e, t, n) => {
        let r = t[0].dims,
          ...
          d = X(u),
          l = x.size(o) / d,
          c = ga(e, t[0], t[1], t[2], s, u, a, n.epsilon),
          p = [s, a, u / d],
          f = [s, a],
          m = ["type", "none"],
          h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      let value = ${y.getByOffset("global_idx")} * ${
              _.type.value
            }(scale_shift.x) + ${_.type.value}(scale_shift.y);
      ${_.setByOffset("global_idx", "value")};
  }`;
          };
        e.compute(
      ...
      (cc = (e, t, n) => {
        ...
        let m = p
          ...
          h = ga(e, m, t[1], t[2], i, a, s, n.epsilon),
          b = (y) => {
...
var pc,
  ...
  ${v.mainStart()}
    ...
    let inv_std_dev = inverseSqrt(${Te(
      "mean_square_vector",
      m
    ...
    for (var j: u32 = 0; j < uniforms.norm_size_vectorized; j++) {
      ...
      output[j + offset] = ${T[0].type.value}((f32input ${
              r ? "" : "- mean"
  ...
  va = k(() => {
    ...
    (fc = (e) => {
      ...
      ($a = (e) => {
        ...
        if (n < 8 && r < 8) e.compute(sn(e.inputs, { activation: "" }, t));
        else {
          let o = t[t.length - 2],
...
var hc,
  ...
  Ta = k(() => {
    ...
    (hc = (e, t) => {
      ...
      if (e.length === 4) {
        let l = e[3].dims,
          c = t.n * (t.bits === 8 ? o : Math.floor((o * t.bits + 7) / 8));
      ...
      (gc = (e, t) => {
        ...
        let T = (I) => {
          let A = w.length,
            ...
            M = S("b", 12, v.length, f),
            U = S("scales", e[2].dataType, e[2].dims.length),
            G = [z, M, U],
            B =
              e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
          B && G.push(B);
          let ee = $.length,
            W = C("output", e[0].dataType, ee, m),
            D = re(e[0].dataType),
            Z = (() => {
              switch (p) {
                case 1:
            ...
            R = () => {
              let se = `
          // reuse a data
            var input_offset = ${z.indicesToOffset(
              `${z.type.indices}(batch, row, word_offset)`
            )};
            var a_data: ${Z};
          ...
          `;
            ...
            b_quantized_values = ${Z}(${Array.from(
                  { length: 4 },
                  (E, L) =>
                    `${D}(b_value_lower[${L}]), ${D}(b_value_upper[${L}])`
                ).join(", ")});
            b_dequantized_values = ${
              p === 1
                ? `${Z}(${Array.from(
                    { length: 8 },
                    (E, L) =>
                      `(b_quantized_values[${L}] - ${
                        B ? `zero_point${H}` : "zero_point"
                      }) * scale${H}`
                  ).join(", ")});`
                : `(b_quantized_values - ${Z}(${Array(8)
                    .fill(`${B ? `zero_point${H}` : "zero_point"}`)
                    .join(",")})) * scale${H};`
            };
          ...
          `;
            ...
            we = () => {
              ...
              for (let H = 0; H < m * b; H++)
                se += `
            let b${H}_data = ${M.getByIndices(
                  `${M.type.indices}(col_index, block, word)`
                )};
            col_index += 1;`;
              return (
                (se += `
        ...
        ${I.mainStart([g, 1, 1])}
          let output_indices = ${W.offsetToIndices(
            `(global_idx / ${g}) * ${b}`
          )};
          ...
          if (local_id.x < ${b}) {
            ...
            ${W.setByIndices(
              `${W.type.indices}(batch, row, col + local_id.x)`,
              "output_value"
            )};
          }
        }`;
        ...
        ${M.mainStart([y, b, 1])}
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var a_offset = local_idx; a_offset < ${_}; a_offset += ${h})
            {
              ...
              {
                sub_a[a_offset] = ${G.getByIndices(
                  `${G.type.indices}(batch, row, a_col)`
                )};
              } else {
            ...
            let zero_point_word = ${D.getByOffset(
              "zero_point_word_index"
            )} >> zero_point_bits_offset;
            ...
            let b_data = ${B.getByIndices(
              `${B.type.indices}(b_row, block, 0)`
            )};
            ...
            (se, H) => `${Q}(b_value_lower[${H}]), ${Q}(b_value_upper[${H}])`
              ...
              let b_dequantized_values = (b_quantized_values - mat2x4<${Q}>(${Array(
            8
          )
            .fill("zero_point")
            .join(",")})) * scale;
          ...
          if (local_idx < ${b}) {
            ...
            {
              ${R.setByIndices(
                `${R.type.indices}(batch, row, col + local_idx)`,
                "output_value"
              )}
            }
          }
  ...
  Ca = k(() => {
    ...
    (bc = (e) => {
      ...
      (_c = (e, t, n) => {
        ...
        for (let o = t - 1; o >= 0; --o)
          r += `
            k = i32(${e.indicesGet("indices", o)}) - ${O(
            "uniforms.pads",
            o,
            n
          )};
      ...
      (Tc = (e, t) => {
        if (e.length > 1) {
          ...
          let s = [];
          return (
            i.forEach((a) => s.push(a)), { mode: t.mode, value: r, pads: s }
          );
        } else return t;
      }),
      (Ia = (e, t) => {
...
var pn,
  ...
  Ha = k(() => {
    ...
    K();
    (pn = (e) => {
      if (ne.webgpu.validateInputContent && (!e || e.length !== 1))
      ...
      (Aa = (e, t, n) => {
        ...
        let i = Object.hasOwnProperty.call(t, "dilations"),
          ...
          d = t.pads.slice();
        Xe.adjustPoolAttributes(n, o, s, a, u, d);
        let l = Xe.computePoolOutputShape(n, o, a, u, s, d, t.autoPad),
          c = Object.assign({}, t);
        i
          ? Object.assign(c, {
              kernelShape: s,
      ...
      (Ic = (e) => `${Pa(e)};${e.countIncludePad}`),
      (Cc = (e) => `${Pa(e)};${e.storageOrder};${e.dilations}`),
      (za = (e) => ({
        format: e.format,
      ...
      (Ba = (e, t, n, r) => {
        ...
        return {
          ...
          getShaderSource: (b) =>
            ka(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m),
        };
      }),
      (Da = (e) => {
      ...
      (Oa = (e, t) => {
        pn(e.inputs), e.compute(Ba("AveragePool", e.inputs[0], !1, t));
      }),
      (Ma = {
        autoPad: "",
        ceilMode: 0,
      ...
      (Ua = (e) => {
        let t = e.format;
        return { format: t, ...Ma, cacheKey: t };
      }),
      (Ra = (e, t) => {
        pn(e.inputs), e.compute(Ba("GlobalAveragePool", e.inputs[0], !0, t));
      }),
      (Va = (e, t, n, r) => {
        let [o, i] = Aa(t, r, n),
          s = `
    ...
    `,
      ...
      (Na = (e, t) => {
        pn(e.inputs), e.compute(Va("MaxPool", e.inputs[0], !1, t));
      }),
      (La = (e) => {
      ...
      (Ga = (e, t) => {
        pn(e.inputs), e.compute(Va("GlobalMaxPool", e.inputs[0], !0, t));
      });
  });
var Ec,
  kc,
  ...
  Ka = k(() => {
    ...
    (Ec = (e, t) => {
          ...
          ${
            v
              ? f
                ...
                ? u
                  ? `
                let zero_point_index = ${$.indicesGet(
                  "output_indices",
                  "uniforms.axis"
                )};
                ...
                let zero_point_input = ${v.getByOffset(
                  "zero_point_offset / 4"
                )};
                let zero_point_vec = ${
                  o
              ...
              : `let zero_point_value = ${
                  u ? (o ? "i32" : "u32") : _.type.value
                }(0);`
          };
      // Compute and write output
      ${$.setByOffset(
        "global_idx",
        `${$.type.value}(x_value - zero_point_value) * scale_value`
      )};
      }`;
          };
        return {
      ...
      (Fa = (e) => N({ axis: e.axis, blockSize: e.blockSize }));
  });
var Pc,
  zc,
  ja,
    ...
    (Pc = (e, t, n) => {
      ...
      (ja = (e) => {
        ...
        e.inputs[0].dataType === 6
          ...
          ne.webgpu.validateInputContent && Pc(t, n, r),
          e.compute(zc(t, n, r, e.inputs[0].dataType), { inputs: [] });
      });
  });
var Bc,
  Dc,
    ...
    (Bc = (e, t, n, r) => {
      ...
      (Dc = (e, t) => {
        let n = e[0].dims,
          ...
          o = n,
          i = 1,
          s = Math.ceil(x.sizeToDimension(r, r.length - 1) / i),
          a = r[r.length - 1],
          ...
          l = (c) => {
            let p = S("indices", e[1].dataType, e[1].dims.length),
              f = S("updates", e[2].dataType, e[2].dims.length, i),
              m =
                t.reduction !== "none" && t.reduction !== ""
                  ? So("output", e[0].dataType, o.length)
    ...
    (Oc = (e, t) => {
      ...
      (Uc = (e, t, n, r, o, i) => {
        ...
        if (
          ...
          Oc(r, t),
            t.axes.length > 0 && Mc(r, t.axes, d).forEach((l, c) => (r[c] = l));
        }
        if (
          u > 0 &&
          e.length > u &&
...
`),
    ...
    fn checkInputIndices(input_indices: ${e.type.indices}) -> bool {
      for (var i:u32 = 0; i < ${t.length}; i++) {
        ...
        if (input_index < 0 || input_index >= ${O(
...
`
      ...
      (Kc = (e, t, n, r, o, i, s, a, u, d) => {
        let l = n.length === 2,
          ...
          h = (b) => {
            let y = b === p ? "row" : "col";
            return `
      fn ${y}CubicInterpolation(input_indices: ${
              e.type.indices
            }, output_indices: ${t.type.indices}) -> ${m} {
        var output_index = ${t.indicesGet("output_indices", b)};
        var originalIdx: ${m} = getOriginalCoordinateFromResizedCoordinate(output_index, ${
              o[b]
            },
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      (Zc = (e, t, n, r, o, i) => {
        let s = e.dims,
          a = Nc(i, t.axes, s.length),
          u = Lc(s, r, o, t.axes),
          d = r.slice();
        r.length === 0 &&
          ((d = s.map((g, _) => (g === 0 ? 1 : u[_] / g))),
          t.keepAspectRatioPolicy !== "stretch" && (u = Wc(s, d, t)));
...
`
      ...
      (tu = (e, t) => {
        ...
        Uc(e.inputs, t, i, n, r, o),
          e.compute(Zc(e.inputs[0], t, i, n, r, o), { inputs: [0] });
      }),
      (nu = (e) => {
        let t = e.antialias,
          n = e.axes,
    ...
    (Xc = (e) => {
      ...
      (ou = (e, t) => {
        ...
        e.outputCount > 1 && r.push(-3),
          ...
          e.compute(Yc(e.inputs, t, e.outputCount, !1), { outputs: r });
      });
  });
var Jc,
  mn,
  ...
  du = k(() => {
    ...
    (Jc = (e, t) => {
      ...
      (tp = (e, t, n) => `fn calculateInputIndices(output_indices: ${
        t.type.indices
      }) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      (op = (e, t) => {
        ...
        a
          ? ((d = Array.from({ length: i }, (T, I) => I)),
            (d[s] = i - 1),
            (d[i - 1] = s),
            (u = e.compute(pe(n, d), { inputs: [n], outputs: [-1] })[0]))
          : (u = n);
        let l = u.dims,
          c = l[i - 1],
          p = o / c,
  ...
  hu = k(() => {
    ...
    (mu = (e) => Array.from(e.getBigInt64Array(), Number)),
      ...
      for (var i = 0; i < ${n.length}; i++) {
        ...
        let input_dim_value = ${u.indicesGet(
          "output_indices",
          "i"
        )}  % input_dim_i;
    ...
    (up = (e, t, n, r, o) => {
      ...
      if (!r)
        ...
        let c = (p, f, m = "") => {
          ...
          return `
            let output_indices${f} = ${i.offsetToIndices(
            `global_idx * 4u + ${f}u`
          )};
            let offset_a${f} = ${s.broadcastedIndicesToOffset(
            `output_indices${f}`,
            i
          )};
            let offset_b${f} = ${a.broadcastedIndicesToOffset(
            `output_indices${f}`,
            i
          )};
            let offset_c${f} = ${u.broadcastedIndicesToOffset(
            `output_indices${f}`,
            i
          )};
      ...
      (dp = (e) => {
        ...
        return {
          ...
          getShaderSource: (d) => up(d, e, s, i, o),
          getRunData: () => ({
            outputs: [{ dims: s, dataType: o }],
...
var bu,
  _u = k(() => {
    ...
    bu = new Map([
      ...
      ["FusedConv", [nr, tr]],
      ["Gather", [Hs, Gs]],
      ["GatherElements", [Js, Ys]],
      ["GatherBlockQuantized", [Zs, Qs]],
      ["GatherND", [Fs, Ks]],
      ["Gelu", [vi]],
      ["Gemm", [na, ta]],
      ["GlobalAveragePool", [Ra, Ua]],
      ["GlobalMaxPool", [Ga, Wa]],
      ["Greater", [Qi]],
      ["GreaterOrEqual", [Yi]],
      ["GridSample", [oa, ia]],
      ["GroupQueryAttention", [fa]],
      ["HardSigmoid", [ki, Ei]],
      ["InstanceNormalization", [ya]],
      ["LayerNormalization", [_a]],
      ["LeakyRelu", [xi, ft]],
      ["Less", [Xi]],
      ["LessOrEqual", [Ji]],
      ["Log", [Vi]],
  ...
  wu = k(() => {
    ...
    fn = class {
      ...
      build(t, n) {
        ...
        let s = To(n, this.backend.device.limits),
      ...
      (cr = class {
        ...
        async initialize(t, n) {
          ...
          i("chromium-experimental-timestamp-query-inside-passes") ||
            ...
            (this.adapterInfo = new lr(
              n.info || (await n.requestAdapterInfo())
            )),
            (this.gpuDataManager = vo(this)),
            (this.programManager = new fn(this)),
                ...
                for (let o = 0; o < n.length / 2; o++) {
                  ...
                  if (this.env.webgpu.profiling?.ondata)
                    ...
                    p.forEach((_, w) => {
                      ...
                      console.log(
                        `[profiling] kernel "${s}|${u}|${d}|${l}" ${y}${g}start time: ${h} ns, execution time: ${
                          b - h
                        } ns`
                      );
                  }
        ...
        run(t, n, r, o, i, s) {
          ...
          if (a.length !== n.length || f.length !== p.length) {
            if (f.length === 0) return fe(t.name), p;
            throw new Error(
          ...
          if (l) {
            ...
            l.forEach((I) => {
              ...
              let z = I.type === 10 ? 2 : 4,
                ...
                U;
              I.type === 10
                ? ((U = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z),
                  (M = A.length > 4 ? 16 : z * A.length))
                : ((U = A.length <= 2 ? A.length * z : 16), (M = 16)),
                (_ = Math.ceil(_ / U) * U),
                w.push(_);
              let G = I.type === 10 ? 8 : 4;
              _ += A.length > 4 ? Math.ceil(A.length / G) * M : A.length * z;
            });
            let v = 16;
            _ = Math.ceil(_ / v) * v;
        ...
        createDownloader(t, n, r) {
          return async () => {
            let o = await Ln(this, t, n);
            return Ht(o.buffer, r);
          };
        }
        writeTimestamp(t) {
                  ...
                  j(
                    ...
                    () =>
                      `[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(
                        a
                      )}, gpuDataId=${Number(u)}, size=${Number(d)}`
                  );
...
var mp,
  ...
  An = k(() => {
    ...
    (mp = (e, t) => {
      ...
      (Et = async (e) => {
        mp(e.wasm.numThreads, pt(e.logLevel));
      }),
      (kt = async (e, t) => {
        te().asyncInit?.();
        ...
        {
          let r = (Su(), $t(xu)).init;
          t === "webgpu" && (await r("webgpu", te(), e, n)),
            t === "webnn" && (await r("webnn", te(), e));
        }
      }),
      (et = new Map()),
      (fp = (e) => {
      ...
      (Pt = async (e, t) => {
        ...
        try {
          if (
            (([s, u] = await io(t)), t?.externalData && o.mountExternalData)
          ) {
            let w = [];
          ...
          for (let w = 0; w < c; w++) {
            ...
            m.push(I),
              b.push(
                $ === 0
                  ? { name: I, isTensor: !1 }
                  : { name: I, isTensor: !0, type: Ee($), shape: T }
              );
          }
          for (let w = 0; w < p; w++) {
            let [v, $, T] = Tu(i, w + c);
      ...
      (Iu = async (e, t, n, r, o, i, s = !1) => {
        ...
        try {
          ...
          let y = a._OrtCreateTensor(Ge(d), f, m, b, l.length, zn(p));
          y === 0 &&
            Y(
      ...
      (Bt = async (e, t, n, r, o, i) => {
        ...
        let d = u[0],
          ...
          z = s.stackAlloc(b * a);
        try {
          ([y, g] = ro(i)), Ne("wasm prepareInputOutputTensor");
          for (let B = 0; B < h; B++) await Iu(n[B], _, v, e, l[t[B]], t[B], f);
          for (let B = 0; B < b; B++)
            await Iu(o[B], w, v, e, c[r[B]], h + r[B], f);
          Le("wasm prepareInputOutputTensor");
          for (let B = 0; B < h; B++)
            s.setValue(T + B * a, _[B], "*"),
              s.setValue(I + B * a, l[t[B]], "*");
          for (let B = 0; B < b; B++)
            s.setValue(A + B * a, w[B], "*"),
              s.setValue(z + B * a, c[r[B]], "*");
          if (p && !m) {
            let {
              handle: B,
              outputPreferredLocations: ee,
              outputPreferredLocationsEncoded: W,
            } = p;
            if (l.length !== h)
              throw new Error(
                `input count from feeds (${h}) is expected to be always equal to model's input count (${l.length}).`
              );
            Ne("wasm bindInputsOutputs");
            for (let D = 0; D < h; D++) {
              let Z = t[D];
              (await s._OrtBindInput(B, l[Z], _[D])) !== 0 &&
                Y(`Can't bind input[${D}] for session=${e}.`);
            }
            for (let D = 0; D < b; D++) {
              let Z = r[D];
              o[D]?.[3]
                ? s._OrtBindOutput(B, c[Z], w[D], 0) !== 0 &&
                  Y(`Can't bind pre-allocated output[${D}] for session=${e}.`)
                : s._OrtBindOutput(B, c[Z], 0, W[Z]) !== 0 &&
                  Y(`Can't bind output[${D}] to ${ee[D]} for session=${e}.`);
            }
            Le("wasm bindInputsOutputs"), et.set(e, [d, l, c, p, f, !0]);
          }
          ...
          let U = [],
            G = [];
          Ne("wasm ProcessOutputTensor");
          for (let B = 0; B < b; B++) {
            let ee = Number(s.getValue(A + B * a, "*"));
            if (ee === w[B]) {
              U.push(o[B]);
              continue;
            }
            ...
            try {
              s._OrtGetTensorData(ee, D, D + a, D + 2 * a, D + 3 * a) !== 0 &&
                Y(`Can't access output tensor data on index ${B}.`);
              let se = a === 4 ? "i32" : "i64",
                H = Number(s.getValue(D, se));
              Q = s.getValue(D + a, "*");
              let E = s.getValue(D + a * 2, "*"),
                L = Number(s.getValue(D + a * 3, se)),
                oe = [];
              for (let ue = 0; ue < L; ue++)
                oe.push(Number(s.getValue(E + ue * a, se)));
              s._OrtFree(E) !== 0 && Y("Can't free memory for tensor dims.");
              let $e = oe.reduce((ue, ae) => ue * ae, 1);
              R = Ee(H);
              let xe = p?.outputPreferredLocations[r[B]];
              if (R === "string") {
                ...
                for (let ae = 0; ae < $e; ae++) {
                  let Ve = s.getValue(Q + ae * a, "*"),
                    ...
                    gr = ae === $e - 1 ? void 0 : wt - Ve;
                  ue.push(s.UTF8ToString(Ve, gr));
                }
                U.push([R, oe, ue, "cpu"]);
              } else if (xe === "gpu-buffer" && $e > 0) {
                ...
                (Z = !0),
                  U.push([
                    ...
                    {
                      gpuBuffer: ae,
                      download: s.jsepCreateDownloader(ae, Ve, R),
                      dispose: () => {
                ...
                if (He(H, $e) === void 0 || !Lt(R))
                  throw new Error(`Unsupported data type: ${R}`);
                if (!ae(e, R, !1))
                  throw new Error(
                    `preferredLocation "ml-tensor" for ${R} output is not supported by current WebNN Context.`
                  );
                ...
                (Z = !0),
                  U.push([
                    ...
                    {
                      mlTensor: wt,
                      download: s.webnnCreateMLTensorDownloader(Q, R),
                      dispose: () => {
              ...
              } else if (xe === "ml-tensor-cpu-output" && $e > 0) {
                let ue = s.webnnCreateMLTensorDownloader(Q, R)(),
                  ae = U.length;
                (Z = !0),
                  G.push(
                    (async () => {
                      let Ve = [ae, await ue];
                      return (
                        s.webnnReleaseTensorId(Q), s._OrtReleaseTensor(ee), Ve
                      );
                    })()
                  ),
                  U.push([R, oe, [], "cpu"]);
          ...
          p &&
            ...
            (s._OrtClearBoundOutputs(p.handle) !== 0 &&
              Y("Can't clear bound outputs."),
            et.set(e, [d, l, c, p, f, !1]));
          for (let [B, ee] of await Promise.all(G)) U[B][2] = ee;
          return Le("wasm ProcessOutputTensor"), U;
        } finally {
          s.webnnOnRunEnd?.(d),
            s.stackRestore($),
...
var tt,
  ...
  hr = k(() => {
    ...
    We();
    Ct();
    (tt = () => !!ne.wasm.proxy && typeof document < "u"),
      (_t = !1),
      (gn = !1),
      (yn = !1),
      (fr = new Map()),
      (st = (e, t) => {
        let n = fr.get(e);
        n ? n.push(t) : fr.set(e, [t]);
      }),
      (at = () => {
        if (_t || !gn || yn || !ve) throw new Error("worker not ready");
      }),
      (gp = (e) => {
        switch (e.data.type) {
          case "init-wasm":
            (_t = !1),
              e.data.err
                ? ((yn = !0), mr[1](e.data.err))
                : ((gn = !0), mr[0]()),
              hn && (URL.revokeObjectURL(hn), (hn = void 0));
            break;
          case "init-ep":
          case "copy-from":
          case "create":
      ...
      (Cu = async () => {
        if (!gn) {
          ...
          if (yn) throw new Error("previous call to 'initWasm()' failed.");
          if (((_t = !0), tt()))
          ...
          try {
            await At(ne.wasm), await Et(ne), (gn = !0);
          } catch (e) {
            throw ((yn = !0), e);
          } finally {
            _t = !1;
        ...
        if (tt()) {
          ...
          return (
            ...
            new Promise((s, a) => {
              ...
              ve.postMessage(d, Ot(u));
            })
          );
        } else return Bt(e, t, n, r, o, i);
      }),
      (Bu = async (e) => {
        if (tt())
          return (
...
var Uu = {};
ut(Uu, {
  OnnxruntimeWebAssemblyBackend: () => _n,
  initializeFlags: () => Mu,
  wasmBackend: () => bp,
});
var Mu,
  ...
  Ru = k(() => {
    ...
    Ou();
    (Mu = () => {
      (typeof ne.wasm.initTimeout != "number" || ne.wasm.initTimeout < 0) &&
        (ne.wasm.initTimeout = 0);
      let e = ne.wasm.simd;
      if (
        (typeof e != "boolean" &&
          e !== void 0 &&
          ...
          (ne.wasm.simd = !1)),
        typeof ne.wasm.proxy != "boolean" && (ne.wasm.proxy = !1),
        typeof ne.wasm.trace != "boolean" && (ne.wasm.trace = !1),
        typeof ne.wasm.numThreads != "number" ||
          !Number.isInteger(ne.wasm.numThreads) ||
          ne.wasm.numThreads <= 0)
      )
...
var Ev = Cn;
{
  let e = (Ru(), $t(Uu)).wasmBackend;
  je("webgpu", e, 5), je("webnn", e, 5), je("cpu", e, 10), je("wasm", e, 10);
}
Object.defineProperty(ne.versions, "web", { value: qr, enumerable: !0 });
export {
  Hu as InferenceSession,
  St as TRACE,
  Ne as TRACE_EVENT_BEGIN,
  Le as TRACE_EVENT_END,
  ge as TRACE_FUNC_BEGIN,
  fe as TRACE_FUNC_END,
  Se as Tensor,
  Ev as default,
  ne as env,
  je as registerBackend,
};
/**
 * @license
