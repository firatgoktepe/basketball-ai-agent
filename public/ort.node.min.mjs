...
var De,
  ...
  me = M(() => {
    "use strict";
    re();
    (De = $ || typeof location > "u" ? void 0 : location.origin),
      (Ot = import.meta.url > "file:" && import.meta.url < "file;"),
      (Lt = () => {
        if (!$) {
          if (Ot) {
            let e = URL;
            return new URL(new e("ort.node.min.mjs", import.meta.url).href, De)
              .href;
          }
      ...
      (vt = async (e) => (await import(/*webpackIgnore:true*/ e)).default),
      (Ue = void 0),
      (xe = async (e, t, n, o) => {
        let r = Ue && !(e || t);
        if (r)
          ...
          S.push(
            new Promise((I, v) => {
              ...
              if (f) b.wasmBinary = f;
                ...
                b.locateFile = (w) => new URL(w, i).href;
              else if (d) {
                let w = Ae();
    ...
    We = (e) => {
      ...
      try {
        ...
        return (
          ...
          n === 0 && g("Can't create run options."),
          e?.extra !== void 0 &&
            K(e.extra, "", new WeakSet(), (s, i) => {
              let u = A(s, o),
                l = A(i, o);
              t._OrtAddRunConfigEntry(n, u, l) !== 0 &&
                g(`Can't set a run config entry: ${s} - ${i}.`);
            }),
          [n, o]
        );
      } catch (a) {
    ...
    (xt = (e) => {
      ...
      (se = (e, t, n, o) => {
        ...
        y()._OrtAddSessionConfigEntry(e, r, a) !== 0 &&
          g(`Can't set a session config entry: ${t} - ${n}.`);
      }),
      (Wt = async (e, t, n) => {
        for (let o of t) {
            ...
            case "webgpu":
              if (((r = "JS"), typeof o != "string")) {
                ...
                if (f?.preferredLayout) {
                  if (
                    f.preferredLayout !== "NCHW" &&
                    f.preferredLayout !== "NHWC"
                  )
                    throw new Error(
                      `preferredLayout must be either 'NCHW' or 'NHWC': ${f.preferredLayout}`
                    );
          ...
          let s = A(r, n),
            ...
            l = 0;
          if (i > 0) {
            (u = y()._malloc(i * y().PTR_SIZE)),
              n.push(u),
              (l = y()._malloc(i * y().PTR_SIZE)),
              n.push(l);
            for (let f = 0; f < i; f++)
              y().setValue(u + f * y().PTR_SIZE, a[f][0], "*"),
                y().setValue(l + f * y().PTR_SIZE, a[f][1], "*");
          }
          (await y()._OrtAppendExecutionProvider(e, s, u, l, i)) !== 0 &&
            g(`Can't append execution provider: ${r}.`);
        }
      }),
      (Fe = async (e) => {
        let t = y(),
        ...
        Ct(r);
        try {
          let a = xt(r.graphOptimizationLevel ?? "all"),
            s = Mt(r.executionMode ?? "sequential"),
            i = typeof r.logId == "string" ? A(r.logId, o) : 0,
          ...
          if (
            ...
            n === 0 && g("Can't create session options."),
            r.executionProviders && (await Wt(n, r.executionProviders, o)),
          ...
          if (r.freeDimensionOverrides)
            for (let [d, c] of Object.entries(r.freeDimensionOverrides)) {
              if (typeof d != "string")
                throw new Error(
              ...
              if (typeof c != "number" || !Number.isInteger(c) || c < 0)
                throw new Error(
                  `free dimension override value must be a non-negative integer: ${c}`
                );
              let p = A(d, o);
              t._OrtAddFreeDimensionOverride(n, p, c) !== 0 &&
                g(`Can't set a free dimension override: ${d} - ${c}.`);
            }
          return (
            r.extra !== void 0 &&
              K(r.extra, "", new WeakSet(), (d, c) => {
                se(n, d, c, o);
              }),
            [n, o]
          );
          ...
          throw (
            (n !== 0 &&
              ...
              g("Can't release session options."),
            o.forEach((s) => t._free(s)),
            a)
          );
        }
        ...
        if ($)
          try {
            ...
            if (t.code === "ERR_FS_FILE_TOO_LARGE") {
              let { createReadStream: n } = de("node:fs"),
                o = n(e),
                r = [];
...
import {
  TRACE_EVENT_BEGIN as je,
  TRACE_EVENT_END as ze,
  ...
  Qe = M(() => {
    ...
    (kt = (e, t) => {
      ...
      (Ft = (e) => {
        ...
        try {
          ...
          t._OrtGetInputOutputCount(e, r, r + o) !== 0 &&
            g("Can't get session input/output count.");
          let s = o === 4 ? "i32" : "i64";
      ...
      (He = (e, t) => {
        ...
        try {
          ...
          n._OrtGetInputOutputMetadata(e, t, s, s + a) !== 0 &&
            g("Can't get session input/output metadata.");
          let u = Number(n.getValue(s, "*"));
          r = Number(n.getValue(s + a, "*"));
          let l = n.HEAP32[r / 4];
          if (l === 0) return [u, 0];
          let f = n.HEAPU32[r / 4 + 1],
            d = [];
          for (let c = 0; c < f; c++) {
      ...
      (Ye = async (e, t) => {
        ...
        try {
          if (
            (([s, u] = await Fe(t)), t?.externalData && r.mountExternalData)
          ) {
            let E = [];
            for (let h of t.externalData) {
              let B = typeof h == "string" ? h : h.path;
              E.push(
                Q(typeof h == "string" ? h : h.data).then((U) => {
            ...
            if ((typeof E == "string" ? E : E.name) === "webnn") {
              if (((r.shouldTransferToMLTensor = !1), typeof E != "string")) {
                ...
                U
                  ? (r.currentContext = U)
                  : P
                  ? (r.currentContext = await r.webnnCreateMLContext(P))
          ...
          for (let E = 0; E < d; E++) {
            ...
            S.push(P),
              v.push(
                B === 0
                  ? { name: P, isTensor: !1 }
                  : { name: P, isTensor: !0, type: ae(B), shape: U }
              );
          }
          for (let E = 0; E < c; E++) {
            let [h, B, U] = He(a, E + d);
          ...
          return Y.set(a, [a, l, f, null, p, !1]), [a, S, I, v, b];
        } catch (d) {
          throw (
            (l.forEach((c) => r._OrtFree(c)),
            f.forEach((c) => r._OrtFree(c)),
            i !== 0 &&
              r._OrtReleaseBinding(i) !== 0 &&
              g("Can't release IO binding."),
            a !== 0 &&
              r._OrtReleaseSession(a) !== 0 &&
              g("Can't release session."),
            d)
          );
        } finally {
          r._free(n),
      ...
      (Ze = (e) => {
        ...
        s &&
          ...
          t._OrtReleaseSession(o) !== 0 && g("Can't release session."),
          Y.delete(e);
      }),
      (Ve = async (e, t, n, o, r, a, s = !1) => {
        ...
        if (d === "gpu-buffer") {
          ...
          if (Array.isArray(b)) {
            ...
            for (let w = 0; w < b.length; w++) {
              if (typeof b[w] != "string")
                throw new TypeError(
                  `tensor data at index ${w} is not a string`
                );
              i.setValue(p + w * u, A(b[w], n), "*");
            }
          } else {
            let w = i.webnnIsGraphInput,
              C = i.webnnIsGraphOutput;
            if (l !== "string" && w && C) {
              let E = i.UTF8ToString(r);
              if (w(o, E) || C(o, E)) {
                let h = q(l);
                (S = J(h, f)), (c = "ml-tensor");
                let B = i.webnnCreateTemporaryTensor,
                  U = i.webnnUploadTensor;
                if (!B || !U)
                  throw new Error(
                    'Tensor location "ml-tensor" is not supported without using WebNN.'
                  );
                let P = await B(o, h, f);
                U(P, new Uint8Array(b.buffer, b.byteOffset, b.byteLength)),
                  (p = P);
              } else
                (S = b.byteLength),
                  (p = i._malloc(S)),
        ...
        let I = i.stackSave(),
          v = i.stackAlloc(4 * f.length);
        try {
          f.forEach((w, C) =>
            i.setValue(v + C * u, w, u === 4 ? "i32" : "i64")
          );
      ...
      (Xe = async (e, t, n, o, r, a) => {
        ...
        let l = u[0],
          ...
          Z = s.stackAlloc(v * i);
        try {
          ([b, w] = We(a)), je("wasm prepareInputOutputTensor");
          for (let m = 0; m < I; m++) await Ve(n[m], C, h, e, f[t[m]], t[m], p);
          for (let m = 0; m < v; m++)
            await Ve(r[m], E, h, e, d[o[m]], I + o[m], p);
          ze("wasm prepareInputOutputTensor");
          for (let m = 0; m < I; m++)
            s.setValue(U + m * i, C[m], "*"),
              s.setValue(P + m * i, f[t[m]], "*");
          for (let m = 0; m < v; m++)
            s.setValue(z + m * i, E[m], "*"),
              s.setValue(Z + m * i, d[o[m]], "*");
          s.jsepOnRunStart?.(l), s.webnnOnRunStart?.(l);
          let x;
          (x = await s._OrtRun(l, P, U, I, Z, v, z, b)),
            x !== 0 && g("failed to call OrtRun().");
          let k = [],
            Oe = [];
          je("wasm ProcessOutputTensor");
          for (let m = 0; m < v; m++) {
            ...
            let Le = s.stackSave(),
              ...
              _ = 0;
            try {
              s._OrtGetTensorData(F, W, W + i, W + 2 * i, W + 3 * i) !== 0 &&
                g(`Can't access output tensor data on index ${m}.`);
              let le = i === 4 ? "i32" : "i64",
                ee = Number(s.getValue(W, le));
              _ = s.getValue(W + i, "*");
              let Be = s.getValue(W + i * 2, "*"),
                gt = Number(s.getValue(W + i * 3, le)),
                R = [];
              for (let L = 0; L < gt; L++)
                R.push(Number(s.getValue(Be + L * i, le)));
              s._OrtFree(Be) !== 0 && g("Can't free memory for tensor dims.");
              let N = R.reduce((L, T) => L * T, 1);
              O = ae(ee);
              let X = c?.outputPreferredLocations[o[m]];
              if (O === "string") {
                if (X === "gpu-buffer" || X === "ml-tensor")
                  throw new Error("String tensor is not supported on GPU.");
                let L = [];
                for (let T = 0; T < N; T++) {
                  let G = s.getValue(_ + T * i, "*"),
                    te = s.getValue(_ + (T + 1) * i, "*"),
                    Pe = T === N - 1 ? void 0 : te - G;
                ...
                (H = !0),
                  k.push([
                    ...
                    R,
                    {
                      ...
                      dispose: () => {
                        s._OrtReleaseTensor(F) !== 0 &&
                          g("Can't release tensor.");
                      },
                    },
                    "gpu-buffer",
                  ]);
              } else if (X === "ml-tensor" && N > 0) {
                let L = s.webnnEnsureTensor,
                  T = s.webnnIsGraphInputOutputTypeSupported;
                if (!L || !T)
                  throw new Error(
                    'preferredLocation "ml-tensor" is not supported without using WebNN.'
                  );
                if (J(ee, N) === void 0 || !ue(O))
                  throw new Error(`Unsupported data type: ${O}`);
                if (!T(e, O, !1))
                  throw new Error(
                    `preferredLocation "ml-tensor" for ${O} output is not supported by current WebNN Context.`
                  );
                ...
                let L = s.webnnCreateMLTensorDownloader(_, O)(),
                  T = k.length;
                (H = !0),
                  Oe.push(
                    (async () => {
                      let G = [T, await L];
                      return (
                        s.webnnReleaseTensorId(_), s._OrtReleaseTensor(F), G
                      );
                    })()
                  ),
                  k.push([O, R, [], "cpu"]);
              ...
              s.stackRestore(Le),
                O === "string" && _ && s._free(_),
                H || s._OrtReleaseTensor(F);
            }
          }
          c &&
            !p &&
            (s._OrtClearBoundOutputs(c.handle) !== 0 &&
              g("Can't clear bound outputs."),
            Y.set(e, [l, f, d, c, p, !1]));
          for (let [m, F] of await Promise.all(Oe)) k[m][2] = F;
          return ze("wasm ProcessOutputTensor"), k;
        } finally {
          s.webnnOnRunEnd?.(l),
            s.stackRestore(B),
            C.forEach((x) => s._OrtReleaseTensor(x)),
            E.forEach((x) => s._OrtReleaseTensor(x)),
            h.forEach((x) => s._free(x)),
            b !== 0 && s._OrtReleaseRunOptions(b),
            w.forEach((x) => s._free(x));
        }
      }),
      (Ke = (e) => {
        let t = y(),
...
import { env as he } from "onnxruntime-common";
var Se,
  et,
  tt,
  rt,
    ...
    (Se = !1),
      ...
      (rt = async () => {
        if (!et) {
          ...
          Se = !0;
          try {
            await Ce(he.wasm), await qe(he), (et = !0);
          } catch (e) {
            throw ((tt = !0), e);
          } finally {
            Se = !1;
      ...
      (it = async (e, t, n, o, r, a) => Xe(e, t, n, o, r, a)),
      (ut = async (e) => {
        Ke(e);
      });
  });
import {
  Tensor as Te,
  TRACE_FUNC_BEGIN as ct,
  TRACE_FUNC_END as ft,
} from "onnxruntime-common";
var lt,
  Nt,
  ce,
      ...
      (ce = class {
        ...
        async run(t, n, o) {
          ...
          Object.entries(n).forEach((c) => {
            let p = c[0],
              S = c[1],
              I = this.outputNames.indexOf(p);
            if (I === -1) throw new Error(`invalid output '${p}'`);
            s.push(S), i.push(I);
          });
          let u = r.map((c, p) =>
              lt(c, () => `input "${this.inputNames[a[p]]}"`)
            ),
            l = s.map((c, p) =>
              c ? lt(c, () => `output "${this.outputNames[i[p]]}"`) : null
            ),
            f = await it(this.sessionId, a, u, i, l, o),
            d = {};
          for (let c = 0; c < f.length; c++)
            d[this.outputNames[i[c]]] = s[c] ?? Nt(f[c]);
          return ft(), d;
        }
        startProfiling() {}
        endProfiling() {
...
import { env as D } from "onnxruntime-common";
var dt,
  fe,
  Gt,
  bt = M(() => {
    ...
    pt();
    (dt = () => {
      (typeof D.wasm.initTimeout != "number" || D.wasm.initTimeout < 0) &&
        (D.wasm.initTimeout = 0);
      let e = D.wasm.simd;
      if (
        (typeof e != "boolean" &&
          e !== void 0 &&
          ...
          (D.wasm.simd = !1)),
        typeof D.wasm.proxy != "boolean" && (D.wasm.proxy = !1),
        typeof D.wasm.trace != "boolean" && (D.wasm.trace = !1),
        typeof D.wasm.numThreads != "number" ||
          !Number.isInteger(D.wasm.numThreads) ||
          D.wasm.numThreads <= 0)
      )
        if (typeof self < "u" && !self.crossOriginIsolated)
          ...
          let t =
            typeof navigator > "u"
              ? de("node:os").cpus().length
              : navigator.hardwareConcurrency;
          D.wasm.numThreads = Math.min(4, Math.ceil((t || 1) / 2));
        }
    }),
      (fe = class {
        async init(t) {
...
import * as $t from "onnxruntime-common";
import { registerBackend as wt, env as jt } from "onnxruntime-common";
var _e = "1.23.0";
var zr = $t;
{
  let e = (bt(), Tt(mt)).wasmBackend;
  wt("cpu", e, 10), wt("wasm", e, 10);
}
Object.defineProperty(jt.versions, "web", { value: _e, enumerable: !0 });
